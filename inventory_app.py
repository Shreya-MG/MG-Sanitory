...
# Add this at the very beginning of your app, right after imports
st.set_page_config(
...
def calculate_inventory_status(inventory_df, sales_df):
    ...
    status_df['Total Purchased'] = status_df.groupby('Item')['Quantity Purchased'].transform('sum')
    status_df['Total Sold'] = 0
    status_df['Remaining Quantity'] = status_df['Quantity Purchased']
